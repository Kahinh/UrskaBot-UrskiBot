Dictionnaire = {
    ...
    "TrialListe" : {
        'Notes_part1' : "All **UrskaBot** trial builds are __mainly solobuilds__ and come from the [Trial Official Metasheet](https://docs.google.com/spreadsheets/d/1Kv3nlr7y5DJB_olhATqXXh-jPCkDygNCVyHkDwllTsc/edit#gid=0).",
        'Notes_part2' : "You can follow the link above in order to get other builds and/or pots information and tips.",
        'SummaryRequest' : "__Summary of your request :__",
        "Type" : "- Type :",
        "Weapon" : "- Weapon :",
        "Element" : "- Element :",
    ...
    "MetaListe" : {
        ...
        'CantCalculateEffects' : "Je ne parviens pas à calculer les effets des cellules",
        "Type" : "- Type :",
        "Link" : "__Lien__",
        "Cells" : "__Cellules__",
        "Notes" : "__Remarques__",
    ...
    "TrialListe" : {
        "Notes_part1" : "Tous les builds d'Épreuve d'**UrskiBot** sont des builds __principalement solo__ et proviennent du [Metasheet Officiel des Épreuves](https://docs.google.com/spreadsheets/d/1Kv3nlr7y5DJB_olhATqXXh-jPCkDygNCVyHkDwllTsc/edit#gid=0) (EN).",
        "Notes_part2" : "Vous pouvez suivre le lien ci-dessus afin d'accéder à d'autres builds, des astuces ou des informations sur les toniques à utiliser.",
        'SummaryRequest' : "__Résumé de votre demande :__",

...
file_BuildList = lib.os.path.abspath(lib.os.curdir) + '/gitignore/BuildList.pkl'
file_Reddit_UrskaBot = lib.os.path.abspath(lib.os.curdir) + '/gitignore/FeedRedditID_UrskaBot.pkl'
